    ...
    switch (option) {
        case 'mascota':
            x.innerHTML =
                ...
                "<a href='Login?option=home'>Home</a></li><li class='breadcrumb-item active' aria-current='page'>Mascotas</li></ol></nav>" + //breadcrumb




                "<div class='subMenuButton row align-items-center'><img class='buttonIcon' src='img/Perro.png'>" +
                "<div class='buttonText'><h4>Maya</h4></div></div>" +
                "<div class='subMenuButton row align-items-center'><img class='buttonIcon' src='img/Gato.png'>" +
                "<div class='buttonText'><h4>Kira</h4></div></div>" +
                "<button type='button' class='btn pmd-btn-fab btn-success btn-floating'  onclick='location.href=`addMascota.jsp`'><i class='fa fa-plus fa-lg'></i></button>";

            break;

        case 'lugares':
            x.innerHTML =
                "<nav aria-label='breadcrumb'><ol class='breadcrumb'><li class='breadcrumb-item'><a href='Login?option=home'>Home</a></li>" +
        ...
        case 'ajustes':
            x.innerHTML =
                "<nav aria-label='breadcrumb'><ol class='breadcrumb'><li class='breadcrumb-item'><a href='Login?option=home'>Home</a></li><li class='breadcrumb-item active' aria-current='page'>Ajustes</li>" +
